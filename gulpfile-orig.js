...
elixir(function(mix) {
    mix
        ...
        .copy(resourceDir + 'datatables/buttons.server-side.js', 'public/js/buttons.server-side.js')
        .copy(resourceDir + 'datatables/buttons.css', 'public/css/buttons.css')
        .copy(resourceDir + 'js/admin.js', 'public/js/admin-custom.js')
