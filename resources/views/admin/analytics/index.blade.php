...
<section class="content">
    ...
    <div class="row">
        ...
        trans('admin.fields.analytics.total_visits'), $statistics['total_visits']) !!}
        {!! dashboard_box("bg-green", "user-times",
        trans('admin.fields.analytics.bounce_rate'), $statistics['averages']['bounce'] . "%") !!}
        {!! dashboard_box("bg-yellow", "clock-o",
        trans('admin.fields.analytics.average_time'), formatMilliseconds($statistics['averages']['time'])) !!}
        {!! dashboard_box("bg-red", "exchange",
        trans('admin.fields.analytics.page_visits'),  $statistics['averages']['visit']) !!}
    </div>
    <div class="row">
        <div class="col-md-8">
                ...
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#pages" data-toggle="tab">
                            <i class="fa fa-file"></i> {{ trans('admin.fields.analytics.pages') }}
                        </a>
                    </li>
                    <li>
                        <a href="#keywords" data-toggle="tab">
                            <i class="fa fa-key"></i> {{ trans('admin.fields.analytics.keywords') }}
                        </a>
                    </li>
                    <li>
                        <a href="#entrance-pages" data-toggle="tab">
                            <i class="fa fa-building-o"></i> {{  trans('admin.fields.analytics.entrance_pages') }}
                        </a>
                    </li>
                    <li>
                        <a href="#exit-pages" data-toggle="tab">
                            <i class="fa fa-power-off"></i> {{ trans('admin.fields.analytics.exit_pages') }}
                        </a>
                    </li>
                    <li>
                        <a href="#time-pages" data-toggle="tab">
                            <i class="fa fa-clock-o"></i> {{ trans('admin.fields.analytics.time_pages') }}
                        </a>
                    </li>
                    <li>
                        <a href="#traffic-sources" data-toggle="tab">
                            <i class="fa fa-lightbulb-o"></i> {{ trans('admin.fields.analytics.traffic_sources') }}
                        </a>
                    </li>
                    <li>
                        <a href="#browsers" data-toggle="tab">
                            <i class="fa fa-android"></i> {{ trans('admin.fields.analytics.browsers') }}
                        </a>
                    </li>
                    <li>
                        <a href="#os" data-toggle="tab">
                            <i class="fa fa-linux"></i> {{ trans('admin.fields.analytics.os') }}
                        </a>
                    </li>
                </ul>
        ...
        <div class="col-md-4">
            <div class="box box-solid bg-dark-blue-gradient">
                <div class="box-header">
                    <i class="fa fa-th"></i>
                    <h3 class="box-title">{{ trans('admin.fields.analytics.visits') }}</h3>
                </div>
            ...
            <div class="box box-solid bg-blue-special">
                <div class="box-header">
                    ...
                    <h3 class="box-title">{{ trans('admin.fields.analytics.region_visitors') }}</h3>
                </div>
                <div class="box-body">
        ...
        <div class="col-xs-12">
            <div class="box bg-gray-white">
                <div class="box-header">
                    ...
                    <h3 class="box-title">{{ trans('admin.fields.analytics.world_visitors') }}</h3>
                </div>
                <div class="box-body">
...
<script>
    ...
    $(function() {
        ...
        xkey: 'date',
            ykeys: ['visits'],
            labels: ['{{ trans('admin.fields.analytics.visits') }}'],
            lineColors: ['#3B525E'],
    ...
    function drawRegionsMap() {
        ...
        data.addColumn('string', '{{ trans('admin.fields.analytics.chart_country') }}');
        data.addColumn('number', '{{ trans('admin.fields.analytics.chart_visitors') }}');
    ...
    function drawLocalRegionsMap(){
        var data = new google.visualization.DataTable();
        data.addColumn('string', '{{ trans('admin.fields.analytics.chart_region') }}');
        data.addColumn('number', '{{ trans('admin.fields.analytics.chart_visitors') }}');
